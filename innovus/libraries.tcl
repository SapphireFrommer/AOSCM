...
set tech_files(STANDARD_CELL_SITE) sc12_cln65lp
...
set tech_files(STANDARD_CELLS_RVT_VERILOG) $paths(STANDARD_CELLS_RVT)/verilog/sc12_cln65lp_base_rvt.v
set tech_files(STANDARD_CELLS_RVT_OA) $paths(STANDARD_CELLS_RVT)/oa
set tech_files(STANDARD_CELL_SUPPRESS_MESSAGES) "ENCLF-200 TECHLIB-436 TECHLIB-302 ENCLF-58 LEFPARS-2001 ENCTS-282"
...
set tech_files(IO_SITE) sc12_cln65lp
...
if {$design(FULLCHIP_OR_MACRO)=="MACRO"} {
	set tech_files(SDC_DRIVING_CELL) BUF_X11B_A12TR
	set tech_files(CCOPT_DRIVING_PIN) BUF_X11B_A12TR/Y
	set tech_files(SDC_LOAD_PIN) BUF_X11B_A12TR/A
...
set tech_files(WELLTAP) WELLANTENNATIEPW2_A12TR
set tech_files(WELLTAP_RULE) 20.0
set tech_files(ENDCAPS) "ENDCAPTIE2_A12TR ENDCAPTIE2_A12TR"
set tech_files(CLOCK_BUFFERS) "BUF_X16M_A12TR BUF_X11M_A12TR BUF_X6M_A12TR BUF_X3M_A12TR"
set tech_files(CLOCK_INVERTERS) "INV_X9M_A12TR INV_X6M_A12TR INV_X3M_A12TR INV_X2M_A12TR"
set tech_files(CLOCK_GATES) "POSTICG_X9B_A12TR POSTICG_X6B_A12TR POSTICG_X4B_A12TR POSTICG_X1P4B_A12TR POSTICG_X1B_A12TR"
